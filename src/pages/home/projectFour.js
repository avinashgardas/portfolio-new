                            ...
                            <div className="accordion-content-row">
                              <div className="accordion-content-col">
                                <div className="accordion-image-wrapper">
                                  <img
                                    src="https://i.ibb.co/2th2YT4/screenshot-rocks.png"
                                    alt="Styllar"
                                    loading="lazy"
                                    width="614"
                                    height="614"
                              ...
                              <div className="accordion-content-col primary-col" style={{color: `#FFF`}}>
                                ...
                                <div>
                                  <p>
                                  Revamped an existing JavaScript website that deals with antinque book auctions in the United States.
                                  </p>
                                  <p>
                                  Designed UI components using stylesheets and ReactStrap library, also used complex UI components like mini-calendar, full-calendar, and Stripe payment gateway.
                                  </p>
                                </div>
                                <div className="button-container">
                                  <a
                                    href="http://rbth-fe.s3-website.us-east-2.amazonaws.com/"
