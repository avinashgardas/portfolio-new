...
export default class ProjectFive extends Component {
    constructor(props) {
        super(props);
                            ...
                            <div className="accordion-content-row">
                              <div className="accordion-content-col">
                                <div className="accordion-image-wrapper">
                                  <img
                                    src="https://i.ibb.co/bLrV8Nw/screenshot-rocks-2.png"
                                    alt="Styllar"
                                    loading="lazy"
                                    width="614"
                                    height="614"
                              ...
                              <div className="accordion-content-col primary-col">
                                ...
                                HTML, ReactJS, Redux, SCSS
                                </h4>
                                <div>
                                  <p>
                                  Designed and revamped a digital solution to maintain the cemetery management system for a California based cremation service provider Cypress Lawn.
                                  </p>
                                  <p>
                                  Built complex UI components, integrated Azure Maps to generate polygons on the map which represent
cemeteries.
                                  </p>
                                </div>
                                <div className="button-container">
                                  <a
                                    href="https://cypresslawn.com/resources/memorial-park-resources/locate-a-gravesite/"
