                            ...
                            <div className="accordion-content-row">
                              <div className="accordion-content-col">
                                <div className="accordion-image-wrapper">
                                  <img
                                    src="https://i.ibb.co/mNysMHF/screenshot-rocks-6.png"
                                    alt="Styllar"
                                    loading="lazy"
                                    width="614"
                                    height="614"
                              ...
                              <div className="accordion-content-col primary-col">
                                ...
                                <div>
                                  <p>
                                  Simbi Handmade Jewelry project was designed and developed using WordPress during my final semester at Algonquin.
                                  </p>
                                  <p>
                                  Delivered the project as a team to a real client, mainly used WordPress along with custom CSS
                                  </p>
                                </div>
                                <div className="button-container">
                                  <a
                                    href="https://simbihandmadejewelry.com/"
